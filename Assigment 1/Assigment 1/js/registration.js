...
const picture = document.getElementById('image_input');
...
function validatePicture(){
    {
        var file_extension = picture.value.split('.').pop().toLowerCase(); 
        ...
        console.log(picture.value.split('.').pop().toLowerCase())
